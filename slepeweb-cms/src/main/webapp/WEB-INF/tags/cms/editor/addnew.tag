...
<form>
	...
	<div class="ff">
		<label for="name">Name: </label><div class="inputs"><input name="name" value="" /></div>
	</div>
	...
	<div id="core-commerce">
		<div class="ff">
			<label for="partNum">Part number: </label><div class="inputs"><input type="text" name="partNum" value="" /></div>
		</div>
		
		<div class="ff">
			<label for="price">Price: </label><div class="inputs"><input type="text" name="price" value="0" /></div>
		</div>
		
		<div class="ff">
			<label for="stock">Stock: </label><div class="inputs"><input type="text" name="stock" value="0" /></div>
		</div>
