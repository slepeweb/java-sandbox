...
//	private static final String CATEGORY_SEARCH = "_categorySearch";
	...
	public String searchResultsDefault(HttpServletRequest req, ModelMap model) {
		return searchResults(1, req, model);
	}
	
	@RequestMapping(value="/search/{page}", method=RequestMethod.GET)
	public String searchResults(@PathVariable int page, HttpServletRequest req, ModelMap model) {
